...
=========================================================================================================================-->
    ...
    <link rel="stylesheet" type="text/css" href="../view/library/font-awesome-4.3.0/css/font-awesome.min.css">
...
=========================================================================================================================-->
    ...
    <link rel="stylesheet" type="text/css" href="../view/library/bootstrap/css/bootstrap-theme.min.css">

    <link rel="stylesheet" type="text/css" href="../view/library/bootstrap/css/bootstrap.css">
...
=========================================================================================================================-->
    ...
    <link rel="stylesheet" type="text/css" href="../view/css/color/themecolor.css">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="../view/library/sample.pdf" class="page-scroll">
                                <h3>Map</h3>
                            </a></li>

                        <li><a href="../model/pro/signin.php" class="page-scroll">
                                <h3>Passenger Portal</h3>
                            </a></li>

                        <li><a href="../model/pro/adminsignin.php" class="page-scroll">
                                <h3>Admin</h3>
                            </a></li>
                    </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Metro Rail Ticket, Metro Rail Ticket, Metro Rail Ticket"></span></h1>

                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Management System, Management System, Management System"></span>
                            </h1>

                            <p class="main-heading-text">WELCOME TO,<br />E - TICKETING FOR METRO RAILWAYS</p>

                            <div class="btn-bar">

                                <a href="../model/pro/signin.php" class="btn btn-custom theme_background_color">Book a Ticket Now</a>
                ...
                <div class="row about-box">
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <div class="margin-bottom">
                            ...
                            <h4>Get Metro Rail Tickets from the comfort of your home</h4>

                            <p class="black">Book metro rail tickets from anywhere using the robust ticketing platform
                    ...
                    <div class="col-sm-4 about-line text-center">
                        ...
                        <div class="margin-bottom">
                            ...
                            <h4>Metro Rail & Metro Rail Ticketing related information at your fingertips</h4>
...
=============================================================================================================================-->
    ...
    <script src="../view/library/modernizr.custom.97074.js"></script>

    <script src="../view/library/jquery-1.11.3.min.js"></script>

    <script src="../view/library/bootstrap/js/bootstrap.js"></script>

    <script type="text/javascript" src="../view/js/jquery.easing.1.3.js"></script>

    <!-- [ PLUGIN SCRIPT ] -->

    <script src="../view/library/vegas/vegas.min.js"></script>
    ...
    <script src="../view/js/fappear.js"></script>
    ...
    <script src="../view/js/jquery.magnific-popup.min.js" type="text/javascript"></script>
