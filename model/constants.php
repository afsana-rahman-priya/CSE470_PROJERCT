...
if (!function_exists('connect')) {
    ...
    function connect()
    {
        $con = new mysqli("localhost", "root", "", "mrtms");
...
function printClearance($id)
{
    ...
    $pdf->SetKeywords("Metro Rail Booking System, Rail, Rails, Railway, Booking, Project, System, Website, Portal ");
...
<h1 style="text-align:center"><img src="../view/images/trainlg.png" width="100" height="100"/><br/>METRO RAIL TICKET MANAGEMENT SYSTEM<br/> METRO RAIL TICKET</h1> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+6">Ticket N<u>o</u>: $uniqueCode </font></div>
...
<tr><th><b>Amount:</b></th><td>Tk $amount</td></tr>
...
function printReport($id)
{
    ...
    $pdf->setTextShadow(array('enabled' => true, 'depth_w' => 0.2, 'depth_h' => 0.2, 'color' => array(196, 196, 196), 'opacity' => 1, 'blend_mode' => 'Normal'));
    // Set some content to print
    $html = '<h5 style="text-align:center"><img src="../view/images/trainlg.png" width="80" height="80"/><br/>METRO RAIL TICKET MANAGEMENT SYSTEM<br/> LIST OF BOOKINGS  FOR ' . $date . ' (' . $time . ')</h5> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+1">Train ' . $train . ' (' . $sn . ' Passengers) : ' . $schedule . ' </font></div>' . $result;
    // die($html);
    // Print text using writeHTMLCell()
    $pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);
    // ---------------------------------------------------------
