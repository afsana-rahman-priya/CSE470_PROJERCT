                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        <input type="hidden" class="form-control" name="id"
                                                            value="<?php echo $id ?>" required id="">
                                                        <p>Metro Rail Name : <input type="text" class="form-control"
                                                        ...
                                                        <p>
                                                            ...
                                                            <input class="btn btn-info" type="submit" value="Edit Metro Rail"
                                                                name='edit'>
                                                        </p>
                                                    </form>
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title">Add New Metro Rail &#128646;
                </h4>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input class="btn btn-info" type="submit" value="Add Metro Rail" name='submit'>
                            </td>
                        </tr>
                    </table>
                </form>
...
if (isset($_POST['del_train'])) {
    ...
    if ($con->affected_rows < 1) {
        alert("Metro Rail Could Not Be Deleted. This Metro Rail Has Been Tied To Another Data!");
        load($_SERVER['PHP_SELF'] . "$me");
    } else {
        alert("Metro Rail Deleted!");
        load($_SERVER['PHP_SELF'] . "$me");
    }
}
?>