                            ...
                            <table id="example1" style="align-items: stretch;"
                                ...
                                <tbody>
                                    ...
                                    while ($fetch = $row->fetch_assoc()) {
                                        ...
                                        <td>Tk <?php echo ($fetch['first_fee']); ?></td>
                                        <td>Tk <?php echo ($fetch['second_fee']); ?></td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <p>Metro Rail : <select class="form-control" name="train_id" required
                                                                id="">
                                                                <option value="">Select Metro Rail</option>
                                                                <?php
                                                        ...
                                                        <p>
                                                            ...
                                                            <input type="date" class="form-control"
                                                                ...
                                                                value="<?php echo (date('d-m-Y', strtotime($fetch["date"]))) ?>">
        ...
        <div class="modal-content" align="center">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            Metro Rail : <select class="form-control" name="train_id" required id="">
                                <option value="">Select Metro Rail</option>
                                <?php
