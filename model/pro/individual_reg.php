...
<div class="signup-page">
    <div class="form">
        ...
        <p class="alert alert-info">
            <marquee behavior="" scrollamount="2" direction="">You need to create an account to book/view Metro Rails!
            </marquee>
        </p>
...
<script src="../../view/assets/js/jquery-1.12.4-jquery.min.js"></script>
